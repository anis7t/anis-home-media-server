...
& $NssmExe set $serviceName AppEnvironmentExtra "PATH=$ExtraPath`nMEDIA_SERVER_BASE_DIR=$BaseDir`nMEDIA_SERVER_MEDIA_ROOT=C:\Flicks`nMEDIA_SERVER_ARCHIVE_DIR=D:\Flicks\.archive`nMEDIA_SERVER_UPLOAD_TARGET_DIR=D:\Flicks`nMEDIA_SERVER_UPLOAD_TMP=D:\Flicks\.uploads`nMEDIA_SERVER_DATABASE=$BaseDir\media.db`nMEDIA_SERVER_ENABLE_AMF=1"
