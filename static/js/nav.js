...
/* YouTube seek-bar enhancement loader */
(function () {
  if (document.querySelector('script[data-loader="/static/js/seekbar-youtube.js"]')) return;
  const s = document.createElement('script');
  s.src = '/static/js/seekbar-youtube.js';
  s.dataset.loader = '/static/js/seekbar-youtube.js';
  s.defer = true;
